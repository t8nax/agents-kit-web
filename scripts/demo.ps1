...
# Флоу в форме кита, два сценария из общих этапов. Исполнители этапов заведены в каждой базе.
...
4. [Критерий](stages/criterion.md)
   - возврат: критерий упёрся в незакрытую развилку — этап «Обсуждение»
...
### Критерии
- 1. проверка: будет названа вместе с критерием — где: этап «Критерий»
